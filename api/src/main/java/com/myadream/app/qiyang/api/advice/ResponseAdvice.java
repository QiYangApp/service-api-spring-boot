...
import com.myadream.app.qiyang.common.annotation.IgnoreCommonResponse;
...
public class ResponseAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
        ...
        if (RespEntity.class.equals(type)) {
            ...
            try {
                return (new ObjectMapper()).writeValueAsString((new DefaultMode<Object>()).success(body));
            } catch (JsonProcessingException e) {
                throw new BizException(e.getMessage());
            }
        } else {
            return (new DefaultMode<Object>()).success(body);
        }
    }
}

package com.myadream.app.qiyang.api.advice;
...
import com.myadream.app.qiyang.common.exception.BizException;
...
public class ExceptionAdvice {
    ...
    public RespEntity paramValidExceptionHandler(ParamValidException ex) {
        return (new DefaultMode<List<FieldError>>()).fail(ex.getFieldErrors(), HttpStatus.NOT_ACCEPTABLE, I18nEnum.STATUS_ABNORMAL);
    }
    ...
    public RespEntity appThrowableException(BizException ex) {
        return (new DefaultMode<Throwable>()).fail(ex);
    }
